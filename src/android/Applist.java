...
import android.graphics.Canvas; //https://stackoverflow.com/questions/44447056/convert-adaptiveicondrawable-to-bitmap-in-android-o-preview
...
public class Applist extends CordovaPlugin {
    ...
    static private Bitmap getBitmapFromDrawable(Drawable drawable) { //https://cloud.tencent.com/developer/ask/sof/115070677
    ...
    public static void drawableTofile(Drawable drawable,String path)
    {
            ...
            // Bitmap bitmap=((BitmapDrawable)drawable).getBitmap(); //Enable If your TargetSdkVersion is 35 and MinSDKVersion is 24
            Bitmap bitmap=getBitmapFromDrawable(drawable); // or use this
